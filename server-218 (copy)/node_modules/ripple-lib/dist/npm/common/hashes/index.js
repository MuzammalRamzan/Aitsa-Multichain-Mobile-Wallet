...
exports.computeTransactionSigningHash = (txJSON) => {
    return exports.computeBinaryTransactionSigningHash(ripple_binary_codec_1.encode(txJSON));
};
exports.computeAccountHash = (address) => {
    return sha512Half_1.default(ledgerSpaceHex('account') + addressToHex(address));
};
exports.computeSignerListHash = (address) => {
    return sha512Half_1.default(ledgerSpaceHex('signerList') + addressToHex(address) + '00000000');
};
exports.computeOrderHash = (address, sequence) => {
